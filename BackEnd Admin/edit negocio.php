<?php
			...
			$sql = mysqli_query($link, "SELECT * FROM negocio WHERE id_negocio='$nik'");
			...
			if(isset($_POST['save'])){
				$id_negocio		     = mysqli_real_escape_string($link,(strip_tags($_POST["id_negocio"],ENT_QUOTES)));//Escanpando caracteres 
				...
				if($update){
					header("Location: edit negocio.php?nik=".$nik."&pesan=sukses");
				}else{
