...
<div class="form-label-group mb-3">
    <input type="text" id="nombre ad" name="nombre cupon" class="form-control" placeholder="text" required="required" autofocus="autofocus">
    <label for="nombre cupon">Nombre del cupon:</label>
</div>
<div class="form-label-group mb-3">
    <input type="text" id="descripcion ad" name="descripcion cupon" class="form-control" placeholder="text" required="required" autofocus="autofocus">
    <label for="descripcion cupon">Descripcion del cupon:</label>
</div>
