...
<div class="form-label-group mb-3">
    <input type="text" id="nombre ad" name="nombre ad" class="form-control" placeholder="text" required="required" autofocus="autofocus">
    <label for="nombre ad">Nombre de la publicidad:</label>
</div>
<div class="form-label-group mb-3">
    ...
    <label for="descripcion ad">Descripcion de la publicidad:</label>
</div>
